...
public class MainActivity extends ActionBarActivity
{
    ...
    private void detectObjectLiteVersion()
    {
        ...
        try
        {
            ...
            Core.line(img_scene, p0, p1, scalar, 4);
            Core.line(img_scene, p1, p2, scalar, 4);
            Core.line(img_scene, p2, p3, scalar, 4);
            Core.line(img_scene, p3, p0, scalar, 4);


            Bitmap bitmap = matToBitmap(img_scene);
